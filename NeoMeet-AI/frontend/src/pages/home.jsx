...
function HomeComponent() {
  ...
  const [showAgendaGenerator, setShowAgendaGenerator] = useState(false);
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          <div
            onClick={() => setShowAgendaGenerator(true)}
            style={{
              display: "flex",
              alignItems: "center",
              gap: "8px",
              ...
              padding: "6px 14px",
              borderRadius: 20,
              border: "1px solid rgba(1,140,203,0.3)",
            }}
            onMouseEnter={(e) => { e.currentTarget.style.background = "linear-gradient(135deg, rgba(1,140,203,0.3), rgba(123,47,190,0.3))"; }}
            onMouseLeave={(e) => { e.currentTarget.style.background = "linear-gradient(135deg, rgba(1,140,203,0.15), rgba(123,47,190,0.15))"; }}
          >
            <AutoAwesomeIcon style={{ color: "#018CCB", fontSize: 20 }} />
            <span style={{ fontSize: "15px", fontWeight: "600", color: "#018CCB" }}>AI Tools</span>
          </div>
          <div
      ...
      <AgendaGenerator
        open={showAgendaGenerator}
        onClose={() => setShowAgendaGenerator(false)}
        darkMode={darkMode}
      />
    </>
  );
