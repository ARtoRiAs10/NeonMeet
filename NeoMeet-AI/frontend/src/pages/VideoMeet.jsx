    ...
    <div className={styles.pageWrapper}>
      {askForUsername === true ? (
        ...
        <div className={styles.meetContainer}>
          ...
          {/* AI ASSISTANT PANEL */}
          {showAI && (
            <aside className={styles.chatPanel} style={{ minWidth: 320, maxWidth: 340 }}>
              <AIAssistantPanel
          ...
          <main className={styles.mainArea}>
            ...
            <div className={styles.controlBar}>
              ...
              <IconButton
                onClick={() => { setModal(!showModal); setShowAI(false); }}
              ...
              <IconButton
                onClick={() => { setShowAI(!showAI); setModal(false); }}
                size="large"
                title="AI Assistant"
                sx={{
                  background: showAI
                    ? "linear-gradient(135deg, #018CCB, #7B2FBE)"
                    : "rgba(255,255,255,0.1)",
                  color: "#fff",
                  "&:hover": { background: "linear-gradient(135deg, #018CCB, #7B2FBE)" },
                }}
              >
                <AutoAwesomeIcon />
              </IconButton>
